/**
 * DuckPools Plinko Game Contract v1
 * 
 * Player commits to a plinko bet, house reveals outcome based on ball path.
...

{
  ...
  val startingRow: Int = fromSelf.R7[Int].get
  ...
  def isValidReveal: Boolean = {
    ...
    // Verify commitment: blake2b256(secret || starting position) matches stored commitment
    ...
    val positionBytes = startingRow.toBytes
    val computedHash = blake2b256(secretBytes ++ positionBytes)
